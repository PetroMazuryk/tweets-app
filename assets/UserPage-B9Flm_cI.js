import{j as u,c as G,r as C,a as wt,u as Et,b as A,f as Ce,d as Ot,g as St,e as Tt,L as xt}from"./index-DbWTg2hX.js";import{G as Pt,n as v,F as kt,L as jt,C as Ct,N as Lt}from"./Navigation-BJgKm_NH.js";function Mt(t){return Pt({tag:"svg",attr:{version:"1.1",viewBox:"0 0 16 16"},child:[{tag:"path",attr:{d:"M0.5 8l7.5 7.5v-4.5h8v-6h-8v-4.5z"},child:[]}]})(t)}const $t=v.button`
  width: 140px;
  height: 46px;
  display: flex;
...
`,go=()=>{const t=Et(),e=A(Rt),n=A(Bt),r=A(Dt),o=A(zt),s=A(At),i=C.useRef(!0),[a,l]=C.useState("all"),c=h=>{l(h)};C.useEffect(()=>{i.current&&!n&&(t(Ce({page:o})),i.current=!1)},[t,e.length,o,n]);const f=()=>{!n&&s&&t(Ce({page:o})),yt.scrollToBottom({duration:500,smooth:"easeInOutQuad"})},d=(h,E)=>{t(Ot({tweetId:h,isFollowed:E}))},g=e.filter(h=>a==="follow"?!h.isFollowed:a==="following"?h.isFollowed:!0);return u.jsxs(u.Fragment,{children:[r&&u.jsxs("p",{children:["Error: ",r]}),u.jsx(Kr,{children:u.jsx(Ft,{options:Nt,filter:a,onSelect:c})}),u.jsx(eo,{children:n&&e.length===0?u.jsx(Jr,{size:50,color:"aqua"}):g.map(({id:h,avatar:E,followers:S,tweets:T,user:w,isFollowed:x})=>u.jsxs(to,{children:[u.jsx(no,{src:jt,alt:"Logo Image"}),u.jsx(ro,{src:Yr,alt:"Promo Image"}),u.jsxs(oo,{children:[u.jsx(ao,{src:Gr,alt:"Rectangle line"}),u.jsxs(io,{children:[u.jsx(lo,{src:Vr,alt:"Ellipse png"}),u.jsx(so,{src:E||Zr,alt:w})]})]}),u.jsxs(co,{children:[u.jsxs(fo,{children:["user: ",w]}),u.jsxs(uo,{children:["tweets: ",T]}),u.jsxs(po,{children:["followers: ",S]}),u.jsx(vo,{type:"button",isFollowed:x,onClick:()=>d(h,x),children:x?"Following":"Follow"})]})]},h))}),s&&u.jsx(ho,{onClick:f,disabled:n,children:n&&e.length>0?u.jsx("p",{children:"Loading more..."}):u.jsx("p",{children:"Load more"})}),!s&&u.jsx(mo,{children:"No more tweets to load"})]})};function yo(t){return t&&typeof t=="object"&&"default"in t?t.default:t}var ge=C,z=yo(ge);/*! *****************************************************************************
...
***************************************************************************** */var ye=function(){return ye=Object.assign||function(e){for(var n,r=1,o=arguments.length;r<o;r++){n=arguments[r];for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&(e[s]=n[s])}return e},ye.apply(this,arguments)};function bo(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,r=Object.getOwnPropertySymbols(t);o<r.length;o++)e.indexOf(r[o])<0&&Object.prototype.propertyIsEnumerable.call(t,r[o])&&(n[r[o]]=t[r[o]]);return n}function _o(t,e){e===void 0&&(e={});var n=e.insertAt;if(!(!t||typeof document>"u")){var r=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css",n==="top"&&r.firstChild?r.insertBefore(o,r.firstChild):r.appendChild(o),o.styleSheet?o.styleSheet.cssText=t:o.appendChild(document.createTextNode(t))}}var wo=`.scroll-to-top {
...
`;_o(wo);function Eo(t){t===void 0&&(t=!1),t?window.scrollTo({top:0,behavior:"smooth"}):document.documentElement.scrollTop=0}var Oo=function(t){var e=t.top,n=e===void 0?20:e,r=t.className,o=r===void 0?"":r,s=t.color,i=s===void 0?"black":s,a=t.smooth,l=a===void 0?!1:a,c=t.component,f=c===void 0?"":c,d=t.viewBox,g=d===void 0?"0 0 256 256":d,h=t.svgPath,E=h===void 0?"M222.138,91.475l-89.6-89.6c-2.5-2.5-6.551-2.5-9.051,0l-89.6,89.6c-2.5,2.5-2.5,6.551,0,9.051s6.744,2.5,9.244,0L122,21.85  V249.6c0,3.535,2.466,6.4,6,6.4s6-2.865,6-6.4V21.85l78.881,78.676c1.25,1.25,2.992,1.875,4.629,1.875s3.326-0.625,4.576-1.875  C224.586,98.025,224.638,93.975,222.138,91.475z":h,S=t.width,T=S===void 0?"28":S,w=t.height,x=w===void 0?"28":w,M=bo(t,["top","className","color","smooth","component","viewBox","svgPath","width","height"]),P=ge.useState(!1),k=P[0],p=P[1];return ge.useEffect(function(){var O=function(){p(document.documentElement.scrollTop>=n)};return O(),document.addEventListener("scroll",O),function(){return document.removeEventListener("scroll",O)}},[n]),z.createElement(z.Fragment,null,k&&z.createElement("button",ye({className:"scroll-to-top "+o,onClick:function(){return Eo(l)},"aria-label":"Scroll to top"},M),f||z.createElement("svg",{width:T,height:x,fill:i,viewBox:g},z.createElement("path",{d:E}))))},So=Oo;const To=St(So),xo=v.section`
  padding: 20px;
  min-height: 100vh;
  background: var(--background-body);
`,Po=v.h1`
...
`,Mo=()=>{var n;const e=((n=Tt().state)==null?void 0:n.from)??"/";return u.jsxs(xo,{children:[u.jsx(jo,{smooth:!0}),u.jsxs(Ct,{children:[u.jsx(Lt,{}),u.jsx(Po,{children:"Users Tweets"}),u.jsx(xt,{to:e,children:u.jsx(It,{})}),u.jsx(ko,{children:"Tweet Cards"}),u.jsx(go,{})]})]})};export{Mo as default};
